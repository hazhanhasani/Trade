...
final class TradeCommandCenter
{
    ...
    public function snapshot(?PDO $pdo = null): array
    {
        ...
        return [
            ...
            'headline'=>[
                // Exact full spot-wallet valuation (Toman), not DB-position approximation.
                ...
                // Real account-equity drawdown from wallet snapshots.
