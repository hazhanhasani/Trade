...
<style>
*{box-sizing:border-box;min-width:0}html,body{width:100%;max-width:100%;overflow-x:hidden}body{margin:0;background:#f4f7fb;color:#172033;font-family:Tahoma,Arial,sans-serif}.wrap{width:100%;max-width:860px;margin:auto;padding:18px;overflow-x:hidden}.top,.card,.row,form{max-width:100%;min-width:0}.top{display:flex;justify-content:space-between;gap:12px;align-items:center}.card{background:#fff;border:1px solid #e3e9f2;border-radius:20px;padding:20px;margin-top:14px;box-shadow:0 8px 28px #14213a0b;overflow:hidden}.ok{background:#edfff6;border-color:#b9e9d1}.warn{background:#fff7e8;border-color:#efd49d}.msg{background:#ebfff4;color:#176548;padding:12px;border-radius:12px;margin:12px 0;overflow-wrap:anywhere}.err{background:#fff0f0;color:#a11;padding:12px;border-radius:12px;margin:12px 0;overflow-wrap:anywhere}.muted{color:#68748a;line-height:1.9;overflow-wrap:anywhere;word-break:break-word}.btn{max-width:100%;border:0;border-radius:11px;padding:12px 16px;font-weight:700;cursor:pointer;background:#1769ff;color:#fff;text-decoration:none;display:inline-block;white-space:normal;overflow-wrap:anywhere}.btn.secondary{background:#edf4ff;color:#1454aa}.btn.safe{background:#16784a}.mono{max-width:100%;direction:ltr;text-align:left;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-all;overflow-x:hidden;background:#101827;color:#eef5ff;padding:13px;border-radius:12px;font:13px monospace}.row{display:flex;gap:9px;flex-wrap:wrap;align-items:center}.row>*{max-width:100%;min-width:0}code{max-width:100%;overflow-wrap:anywhere;word-break:break-all}h1,h2{margin-top:0;overflow-wrap:anywhere}@media(max-width:700px){.wrap{padding:11px}.top{flex-direction:column;align-items:flex-start}.row{width:100%}.btn,.row>a,.row>form,.row>form .btn{width:100%;text-align:center}}
