...
<div class="card"><div class="sectionTitle"><h2>مدیریت ریسک و اسکن</h2><span class="muted">سود آینده قابل تضمین نیست؛ معیار نوبیتکس Net Edge پس از هزینه‌هاست.</span></div><form method="post" style="margin-top:14px"><input type="hidden" name="csrf" value="<?=$csrf?>"><input type="hidden" name="action" value="save_settings"><div class="fields">
...
<div class="field"><label>حداکثر پوزیشن همزمان نوبیتکس</label><input type="number" min="1" max="10" name="nobitex_max_positions" value="<?=h($settings['nobitex_max_positions'])?>"></div>
