...
<style>
*{box-sizing:border-box;min-width:0}html,body{width:100%;max-width:100%;overflow-x:hidden}body{font-family:Tahoma,Arial;background:#f4f7fb;color:#172033;margin:0}.wrap{width:100%;max-width:920px;margin:24px auto;padding:16px;overflow-x:hidden}.card,.grid,.box,.row,form{max-width:100%;min-width:0}.card{background:#fff;border:1px solid #e2e8f0;border-radius:20px;padding:20px;margin:12px 0;box-shadow:0 10px 30px #14213a0b;overflow:hidden}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}.box{background:#f7f9fc;border-radius:14px;padding:15px;overflow:hidden}.ok{color:#087857;font-weight:700}.warn{color:#ad6b00;font-weight:700}.bad{color:#a11;font-weight:700}.back,.btn{max-width:100%;display:inline-block;text-decoration:none;background:#1769ff;color:#fff;padding:11px 15px;border-radius:10px;border:0;font-weight:700;cursor:pointer;white-space:normal;overflow-wrap:anywhere}.btn.safe{background:#16784a}.muted{color:#68748a;font-size:13px;overflow-wrap:anywhere;word-break:break-word}.code{max-width:100%;direction:ltr;text-align:left;font-family:monospace;background:#f2f5fa;padding:12px;border-radius:10px;overflow-x:hidden;overflow-y:auto;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-all}.row{display:flex;gap:10px;align-items:center;flex-wrap:wrap}.row>*{max-width:100%;min-width:0}.pill{max-width:100%;padding:7px 10px;border-radius:999px;background:#f2f5fa;font-size:13px;white-space:normal;overflow-wrap:anywhere;word-break:break-word}.msg{background:#ecfff4;color:#176548;padding:12px;border-radius:12px;overflow-wrap:anywhere}.err{background:#fff0f0;color:#a11;padding:12px;border-radius:12px;overflow-wrap:anywhere}h1,h2,h3,p{overflow-wrap:anywhere;word-break:break-word}@media(max-width:700px){.grid{grid-template-columns:1fr}.wrap{margin:0 auto;padding:11px}.row{width:100%;align-items:stretch}.row .back,.row .btn,.row form,.row form .btn{width:100%;text-align:center}}
