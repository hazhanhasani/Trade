...
<div class="top"><div><h1 style="margin:0 0 5px">صرافی‌ها</h1><div class="muted">مدیریت مستقل Bitpin و Nobitex • تحلیل مکمل TradingView</div></div><div class="row"><a class="btn gray" href="/admin/">پنل اصلی</a><a class="btn gray" href="/admin/bot/">ربات‌ها</a><a class="btn gray" href="/admin/tradingview.php">TradingView</a></div></div>
...
<a class="btn" href="/admin/tradingview.php" style="margin-top:10px">تنظیم تحلیل TradingView</a>
</div></div>
